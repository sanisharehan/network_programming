 ...
 *
 * This is the server example for iterative UDP. Thie server is used to test
 * network speed for dat transmission over UDP transport protocol.
 *
*/
...
main(int argc, char *argv[]) {
	...
	default:
		...
		errexit("Usage error: spdtest port_number msg_size wait_time\n");
	}

	fprintf(stderr, "Arguments passed to server %s, %d, %u\n", service, msg_size, wait_time);
